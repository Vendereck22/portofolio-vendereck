  ...
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        Je suis toujours ouvert à la discussion concernant des projets de
        maintenance, developpement web, reparation electronique, mentorat en
        formation technologique, des opportunités de partenariat. N'hésitez pas
        à me contacter en remplissant le formulaire ci-dessous ou en cliquant
        sur les. icônes de réseaux sociaux.
      </p>
      <div className="mx-2">
